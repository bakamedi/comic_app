...
class _$LeftImpl<L, R> extends _Left<L, R> {
...
abstract class _Left<L, R> extends Either<L, R> {
  const factory _Left(final L value) = _$LeftImpl<L, R>;
...
class _$RightImpl<L, R> extends _Right<L, R> {
...
abstract class _Right<L, R> extends Either<L, R> {
  const factory _Right(final R value) = _$RightImpl<L, R>;
