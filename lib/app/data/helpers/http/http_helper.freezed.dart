...
mixin _$RequestResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(StackTrace stackTrace) timeOut,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(StackTrace stackTrace)? timeOut,
...
class _$SuccessImpl<T> implements _Success<T> {
  const _$SuccessImpl({required this.statusCode, required this.data});
...
abstract class _Success<T> implements RequestResult<T> {
  const factory _Success(
      ...
      required final T data}) = _$SuccessImpl<T>;
...
class _$NetworkErrorImpl<T> implements _NetworkError<T> {
  const _$NetworkErrorImpl({required this.stackTrace});
...
abstract class _NetworkError<T> implements RequestResult<T> {
  const factory _NetworkError({required final StackTrace stackTrace}) =
...
class __$$TimeOutImplCopyWithImpl<T, $Res>
    extends _$RequestResultCopyWithImpl<T, $Res, _$TimeOutImpl<T>>
...
class _$TimeOutImpl<T> implements _TimeOut<T> {
  const _$TimeOutImpl({required this.stackTrace});
  ...
  @override
  String toString() {
    return 'RequestResult<$T>.timeOut(stackTrace: $stackTrace)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TimeOutImplCopyWith<T, _$TimeOutImpl<T>> get copyWith =>
      __$$TimeOutImplCopyWithImpl<T, _$TimeOutImpl<T>>(this, _$identity);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return timeOut?.call(stackTrace);
  }
...
abstract class _TimeOut<T> implements RequestResult<T> {
  const factory _TimeOut({required final StackTrace stackTrace}) =
      _$TimeOutImpl<T>;
...
abstract class _UnhandledException<T> implements RequestResult<T> {
  const factory _UnhandledException(
